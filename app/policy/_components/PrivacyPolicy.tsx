export default function PrivacyPolicy() {
  return (
    <div className="py-20">
      <h2 className="text-2xl font-bold mb-10 text-center">Privacy Policy</h2>
      <p className="mb-4 text-neutral-600">
        At Better Spanish, your privacy is important to us. This Privacy Policy
      ...
      <ul className="list-disc list-inside mb-4 text-neutral-600">
        ...
        <li>
          ...
          including preferences, shortcuts saved, and interactions.
        </li>
        <li>
          <strong>Device Data:</strong> Information about your device, such as
          browser type, IP address, and operating system.
        </li>
      </ul>

      <h2 className="text-lg font-medium mb-2">How We Use Your Information</h2>
      <p className="mb-4 text-neutral-600">
      ...
      <ul className="list-disc list-inside mb-4 text-neutral-600">
        ...
        <li>To ensure the security of our app and protect against misuse.</li>
      </ul>

      <h2 className="text-lg font-medium mb-2">How We Protect Your Data</h2>
      <p className="mb-4 text-neutral-600">
        We implement appropriate technical and organizational measures to
        safeguard your personal data against unauthorized access, alteration, or
        disclosure.
      </p>

      <h2 className="text-lg font-medium mb-2">Sharing Your Information</h2>
      <p className="mb-4 text-neutral-600">
      ...
      <ul className="list-disc list-inside mb-4 text-neutral-600">
        ...
        <li>To service providers who assist in operating our app.</li>
        <li>
      ...
      <h2 className="text-lg font-medium mb-2">Changes to This Policy</h2>
      <p className="mb-4 text-neutral-600">
